...
# Load the dataset
try:
    liver_df = pd.read_csv('D:\Projects\Guvi\Multiple_Disease_Prediction\data\indian_liver_patient.csv')
...
X = liver_df.drop(columns=['target','Gender','Total_Protiens','Direct_Bilirubin'], axis=1)
y = liver_df['target']
